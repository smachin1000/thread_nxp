...
{ /* Body */
    ...
    adapt = (tlsf_adaptation_structure_t*)tlsf_memalign(pool_id, (PSP_MEMORY_ALIGNMENT + 1), (size_t)requested_size + sizeof(tlsf_adaptation_structure_t), sizeof(tlsf_adaptation_structure_t));
#else
...
{ /* Body */
...
#ifdef MQX_CHECK_ERRORS
    {
     ...
     adapt = (tlsf_adaptation_structure_t*)tlsf_memalign(pool_id, (size_t)req_align, (size_t)requested_size + sizeof(tlsf_adaptation_structure_t), sizeof(tlsf_adaptation_structure_t));
...
void* _tlsf_pool_create_limited_internal(void* tlsf_pool_ptr, unsigned char* start, unsigned char* end)
{
 #define CORTEX_MEMORY_BARRIER_ADDR ((unsigned char*)0x20000000)
    ...
    if(tlsf_pool_ptr == NULL)
    {
        ...
        {
#if PSP_HAS_DATA_CACHE
            tlsf_pool_ptr = tlsf_create_with_pool(start + block_header_overhead, (unsigned char *) CORTEX_MEMORY_BARRIER_ADDR - (unsigned char *) start - 4 - block_header_overhead, (PSP_MEMORY_ALIGNMENT + 1));
#else          
...
#endif            
#if PSP_HAS_DATA_CACHE
            tlsf_add_pool(tlsf_pool_ptr, CORTEX_MEMORY_BARRIER_ADDR + block_header_overhead, (unsigned char *) end - (unsigned char *) CORTEX_MEMORY_BARRIER_ADDR - 4 - block_header_overhead, (PSP_MEMORY_ALIGNMENT + 1));  
#else
        ...
        {
#if PSP_HAS_DATA_CACHE
            tlsf_pool_ptr = tlsf_create_with_pool(start + block_header_overhead, (unsigned char *) end - (unsigned char *) start - 4 - block_header_overhead, (PSP_MEMORY_ALIGNMENT + 1));
#else          
    ...
    while(totlen > 0)
    {
        ...
        {
#if PSP_HAS_DATA_CACHE
            tlsf_add_pool(tlsf_pool_ptr, start + block_header_overhead, (unsigned char *) CORTEX_MEMORY_BARRIER_ADDR - (unsigned char *) start - 4 - block_header_overhead, (PSP_MEMORY_ALIGNMENT + 1));
            tlsf_add_pool(tlsf_pool_ptr, CORTEX_MEMORY_BARRIER_ADDR + block_header_overhead, (unsigned char *) end - (unsigned char *) CORTEX_MEMORY_BARRIER_ADDR - 4 - block_header_overhead, (PSP_MEMORY_ALIGNMENT + 1));
#else
        ...
        {
#if PSP_HAS_DATA_CACHE
            tlsf_add_pool(tlsf_pool_ptr, start + block_header_overhead, (unsigned char *) end - (unsigned char *) start - 4 - block_header_overhead, (PSP_MEMORY_ALIGNMENT + 1));
#else            
...
{ /* Body */
    ...
    return tlsf_block_size(mem_ptr);
} /* Endbody */
