...
copy "%ROOTDIR%\config\mcu\mkw24d512kw21\mqx_sdk_config.h" "%OUTPUTDIR%\..\config\mqx_sdk_config.h" /Y
copy "%ROOTDIR%\config\board\twrkw24d512kw21\user_config.h" "%OUTPUTDIR%\..\config\user_config.h" /Y
