...
copy "%ROOTDIR%\config\mcu\mk21d50mk11\mqx_sdk_config.h" "%OUTPUTDIR%\..\config\mqx_sdk_config.h" /Y
copy "%ROOTDIR%\config\board\twrk21d50mk11\user_config.h" "%OUTPUTDIR%\..\config\user_config.h" /Y
