...
#define PSP_CPU_GROUP_KINETIS_K0X       (0x00)
...
/* CPU groups for Kinetis V-Series */
#define PSP_CPU_GROUP_KINETIS_KV1X      (0x61)

/* CPU groups for Kinetis W-Series */
#define PSP_CPU_GROUP_KINETIS_KW1X      (0x71)
#define PSP_CPU_GROUP_KINETIS_KW2X      (0x72)

/* Specific CPU identification macros */
/* Kinetis GP K-Series K02 family with Cortex M4 core */
#define PSP_CPU_MK02F12810      (PSP_CPU_NUM(PSP_CPU_ARCH_ARM_CORTEX_M4, PSP_CPU_GROUP_KINETIS_K0X, 0))
#define PSP_CPU_MK0X            (PSP_CPU_NUM(PSP_CPU_ARCH_ARM_CORTEX_M4, PSP_CPU_GROUP_KINETIS_K0X, 0xF))
...
#define PSP_CPU_MK11DN512       (PSP_CPU_NUM(PSP_CPU_ARCH_ARM_CORTEX_M4, PSP_CPU_GROUP_KINETIS_K1X, 4))
...
#define PSP_CPU_MK24F120M       (PSP_CPU_NUM(PSP_CPU_ARCH_ARM_CORTEX_M4, PSP_CPU_GROUP_KINETIS_K2X, 9))
...
#define PSP_CPU_MKV30F128L      (PSP_CPU_NUM(PSP_CPU_ARCH_ARM_CORTEX_M4, PSP_CPU_GROUP_KINETIS_K3X, 4))
...
/* Kinetis GP L-Series KL46 family with Cortex M0+ core */
#define PSP_CPU_KL46Z48M        (PSP_CPU_NUM(PSP_CPU_ARCH_ARM_CORTEX_M0P, PSP_CPU_GROUP_KINETIS_KL4X, 0))
/* Vybrid series family */
#define PSP_CPU_VF65GS10_M4     (PSP_CPU_NUM(PSP_CPU_ARCH_ARM_CORTEX_M4, PSP_CPU_GROUP_VYBRID_M4, 0))
/* Kinetis GP V-Series KV10 family with Cortex M0+ core */
#define PSP_CPU_KV10Z75M        (PSP_CPU_NUM(PSP_CPU_ARCH_ARM_CORTEX_M0P, PSP_CPU_GROUP_KINETIS_KV1X, 0))
#define PSP_CPU_KV1X            (PSP_CPU_NUM(PSP_CPU_ARCH_ARM_CORTEX_M0P, PSP_CPU_GROUP_KINETIS_KV1X, 0xF))
...
/* Kinetis GP W-Series family with Cortex M4 core */
#define PSP_CPU_MKW21D512       (PSP_CPU_NUM(PSP_CPU_ARCH_ARM_CORTEX_M4, PSP_CPU_GROUP_KINETIS_KW2X, 0))
#define PSP_CPU_MKW22D512       (PSP_CPU_NUM(PSP_CPU_ARCH_ARM_CORTEX_M4, PSP_CPU_GROUP_KINETIS_KW2X, 1))
#define PSP_CPU_MKW24D512       (PSP_CPU_NUM(PSP_CPU_ARCH_ARM_CORTEX_M4, PSP_CPU_GROUP_KINETIS_KW2X, 2))
#define PSP_CPU_MKW2X           (PSP_CPU_NUM(PSP_CPU_ARCH_ARM_CORTEX_M4, PSP_CPU_GROUP_KINETIS_KW2X, 0xF))
/* CPU id check support macros */
/* Kinetis GP K-Series family */
#define PSP_MQX_CPU_IS_KINETIS_K0X  ((PSP_GET_CPU_GROUP(MQX_CPU) == PSP_CPU_GROUP_KINETIS_K0X))
...
/* Kinetis GP V-Series family */
#define PSP_MQX_CPU_IS_KINETIS_KV1X ((PSP_GET_CPU_GROUP(MQX_CPU) == PSP_CPU_GROUP_KINETIS_KV1X))

/* Kinetis GP W-Series family */
#define PSP_MQX_CPU_IS_KINETIS_KW2X ((PSP_GET_CPU_GROUP(MQX_CPU) == PSP_CPU_GROUP_KINETIS_KW2X))
...
/* Kinetis GP V-Series family */
#define PSP_MQX_CPU_IS_KINETIS_V     PSP_MQX_CPU_IS_KINETIS_KV1X

/* Kinetis GP W-Series family */
#define PSP_MQX_CPU_IS_KINETIS_W     PSP_MQX_CPU_IS_KINETIS_KW2X
...
#define PSP_CPU_GROUP_KINETIS_K00   PSP_CPU_GROUP_KINETIS_K0X
...
#define PSP_MQX_CPU_IS_KINETIS_K00  PSP_MQX_CPU_IS_KINETIS_K0X

#define PSP_MQX_CPU_IS_KINETIS      (PSP_MQX_CPU_IS_KINETIS_K | PSP_MQX_CPU_IS_KINETIS_L | PSP_MQX_CPU_IS_KINETIS_V | PSP_MQX_CPU_IS_KINETIS_W)
