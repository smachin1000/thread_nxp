...
#if !MQX_USE_MEM && !MQX_USE_LWMEM_ALLOCATOR
  #define MQX_USE_TLSF_ALLOCATOR  1
#else
...
#if MQXCFG_ALLOCATOR
#error Set one of following allocators to 1: MQX_USE_MEM, MQX_USE_LWMEM_ALLOCATOR or MQX_USE_TLSF_ALLOCATOR
#endif
#endif
...
#if (MQXCFG_ENABLE_FP == 1)&&(MQXCFG_ALLOCATOR == 0)
