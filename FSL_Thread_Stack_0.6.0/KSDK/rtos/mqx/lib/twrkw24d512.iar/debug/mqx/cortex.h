...
#define PSP_INIT_STACK_SIZE                         (PSP_MINSTACKSIZE + 256) /* 256 is empirical value */
#endif
...
*/
/* NUMBER_OF_INT_VECTORS is defined in CMSIS header included in kinetis.h. The cortex.h is included later in psp_cpu.h than kinetis.h */
#define PSP_MAXIMUM_INTERRUPT_VECTORS           NUMBER_OF_INT_VECTORS
